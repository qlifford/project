...
<div class="flex flex-col w-[300px] mx-auto py-16">
    <div class="flex gap-4 justify-between">
        <input type="text" wire:model="todoText" wire:keydown.enter="addTodo" placeholder="Enter todo task" class="flex-1">
        <button
    ...
    <div class="py-6">
        @if (count($todos) == 0)
        <p class="text-gray-500 text-center">No todos created</p>            
        @endif
